...
void init(OptionsMap& o) {
  ...
  o["Experience File"]                     << Option("StockfishMZ.exp", on_exp_file);
  ...
  o["MCTSThreads"]                         << Option(1, 1, 1024);
  o["Multi Strategy"]                      << Option(20, 0, 100);
  o["Multi MinVisits"]                     << Option(5, 0, 1000);
  o["BruteForce"]                          << Option(0, 0, 1024, on_full_threads);
  o["Opening variety"]                     << Option (0, 0, 40);
  o["Iccf_MultiPV"]                        << Option(0, 0, 8);
  o["Iccf_Depth"]                          << Option(0, 0, 32);
